namespace SimpleGameFramework.Resource.Bundle.Generated
{
    ...
    {
        public static BundleInfo audio = new BundleInfo("audio.ab",null);
        public static BundleInfo scene_loading_material = new BundleInfo("scene_loading/material.ab",null);
        public static BundleInfo scene_loading_prefab = new BundleInfo("scene_loading/prefab.ab",null);
    ...
    {
        public static AssetInfo audio_AudioComponent = new AssetInfo("AudioComponent",Bundles.audio);
